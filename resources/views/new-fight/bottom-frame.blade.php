...
<head>
  ...
  <title>Sell Or Die – Marketing Fighters</title>
...
<div class="flex justify-center items-start space-x-12">
  ...
  >
    <!-- … your card content … -->   
        ...
        <div class="p-5 flex items-start gap-4">
          ...
          <h2 class="text-5xl font-bold">{{ $ads[0]->headline }}</h2>
        </div>
        <div class="px-5 pb-4 flex-grow">
          <!-- <h3 class="text-2xl font-bold mb-2">Turn Free Time Into Cash</h3> -->
          <p class="text-sm leading-relaxed">{!!  nl2br($ads[0]->body) !!}</p>
        </div>
  ...
  >    
      ...
      <div class="p-5 flex items-start gap-4">
        ...
        <h2 class="text-5xl font-bold word-wrap">{{ $ads[1]->headline }}</h2>
      </div>
      <div class="px-5 pb-4 flex-grow">
        <!-- <h3 class="text-2xl font-bold mb-2">3-Second Hooks That Go Viral</h3> -->
        <p class="text-sm leading-relaxed">{!! nl2br($ads[1]->body) !!}</p>
      </div>
      <div class="bg-gray-100 text-gray-700 px-5 py-3 text-sm flex justify-between items-center rounded-full">
