        ...
        'user' => [
            ...
            'default_interval' => 'monthly',
             ...
             'plans' => [
                [
                    'name' => 'Lightweight',
                    'short_description' => 'Write beautiful rich html fighter ads with lightweight.',
                    'monthly_id' => env('SPARK_STANDARD_MONTHLY_PLAN', 'price_1Re3QlRka3jwrscG5HhWWcNB'),
                    'yearly_id' => env('SPARK_STANDARD_YEARLY_PLAN', 'price_1Re3RaRka3jwrscGymQ9cxdE'),
                    'features' => [

                        'Full HTML WYSIWYG Ads',
                        '30 credits/display',
                        'Feature 3',
                        '30–70 credits/vote',
                ...
                [
                    'name' => 'Heavyweight',
                    'short_description' => 'Heavyweight users are the kings of the ring in the arena',
                    'monthly_id' => env('SPARK_STANDARD_MONTHLY_PLAN', 'price_1Re3SbRka3jwrscG4uYU3Mmz'),
                    'yearly_id' => env('SPARK_STANDARD_YEARLY_PLAN', 'price_1Re3TCRka3jwrscGfAlpCy4z'),
                    'features' => [
                        'AI-Generated Ads',
                        '20 credits/display',
                        '50–100 credits/vote',
